...
const RightSideBar = ({ selectedUser, setselectedUser }) => {
  return (
    selectedUser && (
      <div
        className={`bg-[#8185B2]/10 text-white w-full relative overflow-auto scrollbar-none ${selectedUser ? "max-md:hidden" : ""}`}
      >
        <div className="mt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto">
          <img
